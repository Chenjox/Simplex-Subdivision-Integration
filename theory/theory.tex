...
This Approach circumvents numerical errors due to a directional bias in the subdivision scheme.
...
These deformed tetrahedrons are defined by following points: TODO Update Numbering to coincide with numbering of the mapping\begin{align}
...
\begin{Figure}
    ...
    \begin{tikzpicture}
        ...
        \end{scope}
        \begin{scope}[shift={(8,0)},engineering axonometry]
            ...
            \newcommand{\transcoords}[2]{
                \foreach \p in {#1} {
                    \path (\p) +(#2) coordinate (t\p);
                };
            }
            \draw (o19) -- +(1.0,0,0);
            \draw (o19) -- +(0.0,1.0,0);
            \draw (o19) -- +(0.0,0,1.0);
            \transcoords{o7,o13,o14,o19}{0.0,0.0,-0.5}
            \drawsimplex[blue]{to7}{to13}{to14}{to19}
            \transcoords{o7,o8,o9,o19}{0.9428*0.5,0.0,-1/6}
            \drawsimplex[blue]{to7}{to8}{to9}{to19}
            \transcoords{o9,o10,o11,o19}{0.8165*0.5,0.4714*0.5,1/6}
            \drawsimplex[vermillion]{to9}{to10}{to11}{to19}
            \transcoords{o10,o16,o17,o19}{0.0,0.0,0.5}
            \drawsimplex[vermillion]{to10}{to16}{to17}{to19}
            \transcoords{o15,o16,o8,o19}{0.8165*0.5,-0.4714*0.5,1/6}
            \drawsimplex[blueishGreen]{to15}{to16}{to8}{to19}
            \transcoords{o14,o15,o18,o19}{-0.8165*0.5,-0.4714*0.5,-1/6}
            \drawsimplex[blueishGreen]{to14}{to15}{to18}{to19}
            \drawsimplex[purple]{o11}{o13}{o12}{o19}
            \transcoords{o12,o17,o18,o19}{-0.9428*0.5,0.0,1/6}
            \drawsimplex[purple]{to12}{to17}{to18}{to19}
        \end{scope}
    \end{tikzpicture}
\end{Figure}
