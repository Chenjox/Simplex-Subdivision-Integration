...
Whereas the vertices of the octahedral domain are expressable as \begin{align}
    \mathbf{O}_5 &= \begin{bmatrix}
        B_{10} & B_6 & B_7 & B_{8} & B_9 & B_{5} \\
    \end{bmatrix}
\end{align}\marginnote{The order of $B_5$ and $B_{10}$ had to be swapped, because else the resulting matrix would flip its sign.}
...
\begin{marginfigure}
    ...
    \begin{tikzpicture}
        \begin{scope}[engineering axonometry]
            ...
            %
            \draw[semithick,blue,line join=round] (be5) -- (be9) -- (be8) -- cycle;
            \draw[semithick,blue,line join=round] (be5) -- (be7) -- (be6) -- cycle;
            \draw[semithick,blue,line join=round] (be6) -- (be9) -- (be10) -- cycle;
            \draw[semithick,blue,line join=round] (be8) -- (be7) -- (be10) -- cycle;
            %
            \draw[semithick,red,line join=round,->-] (be5) -- (be10);
            \draw[semithick,red,line join=round,->-] (be6) -- (be7);
            \draw[semithick,red,line join=round,->-] (be7) -- (be8);
            \draw[semithick,red,line join=round,->-] (be8) -- (be9);
            \draw[semithick,red,line join=round,->-] (be9) -- (be6);
        \end{scope}
    \end{tikzpicture}
